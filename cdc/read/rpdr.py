...
import cdc
from .text import ReadTXT, ReadDelimTXT
...
class ReadRPDR(ReadDelimTXT):
    ...
    TEXT_FIELDS = [field.lower().strip() for field in cdc.CONFIG.get('read.rpdr', 'Text_Fields', fallback='Report_Text, Comments, Organism_Text').split(',')]
